...
const handleEmployeeUpdate = async (req, res) => {
  try {
    ...
    // Special handling for photo_url: if a file was uploaded, use the file path; otherwise use the provided photoUrl or keep existing
    const employeeData = {
      ...
      photo_url: req.file ? photoUrl : (photoUrl !== undefined && photoUrl !== null && photoUrl !== '' ? photoUrl : currentEmployee.photo_url),
